        ...
        <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
            <div className="flex flex-col space-y-2 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                    Điền thông tin cần thiết vào bên dưới để {type === "login" ? "đăng nhập" : "đăng ký"}
                </p>
            </div>
            <div className={cn("grid gap-6", className)} {...props}>
                <form action={actionLogin}>
                    <div className="grid gap-2">
                        ...
                        {type === "login" ? <div className="flex justify-between py-2">
                            <span className="text-sm text-muted-foreground">Chưa có tài khoản?</span>
                            <Link href="/register" className="text-sm">Đăng ký ngay</Link>
                        </div> : <div className="flex justify-between py-2">
                            <span className="text-sm text-muted-foreground">Đã có tài khoản?</span>
                            <Link href="/login" className="text-sm">Đăng nhập ngay</Link>
                        </div>}

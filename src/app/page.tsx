        ...
        <main className="bg-main scroll-smooth">
            <div className="md:container px-2 flex min-h-screen flex-col items-center justify-between">
                ...
                <section id={"community"}
                    ...
                    <h2 className={"pb-10 text-center text-3xl font-bold"}>Giao lưu gắn kết</h2>
                    <div
                        className="w-full px-20 grid grid-cols-1 md:grid-cols-3 md:gap-32 rounded-none">
                        <div
                            className="flex flex-col items-center justify-end space-y-8 pb-6 mb-4 h-80 bg-white p-4 shadow rounded-tr-[100px] rounded-bl-[100px]"
                        >
                            <Image
                                alt="Feature 1"
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <p className="break-words px-4 text-sm mt-2">Some content about feature 1 Some content about feature 1</p>
                            </div>
                        </div>
                        <div
                            className="flex flex-col items-center justify-end space-y-8 pb-6 mb-4 h-80 bg-white p-4 shadow rounded-tr-[100px] rounded-bl-[100px]"
                    ...
                    <Button className={"min-w-[100px] rounded-full"}>Tham gia ngay</Button>
                </section>
                ...
                <section id={"register-master"}
                    ...
                    <div className="flex w-full flex-col items-start space-y-2 md:space-y-8">
                        <h2 className="pb-2 text-3xl font-bold">Đăng ký làm chủ sân</h2>
                        <h4 className="text-bold text-xl">Title</h4>
                        <p className="">Description</p>
                        <Link href="/pitch/register">
                            <Button className={"min-w-[100px] rounded-full"}>Đăng ký ngay</Button>
                        </Link>
                    </div>
                ...
                <section id={"contact"}
                    ...
                    <div className="flex w-full flex-col items-start space-y-2 md:space-y-8">
                        <h2 className="pb-2 text-3xl font-bold">Hỗ trợ tận tình</h2>
                        <h4 className="text-bold text-xl">Title</h4>
                        <p className="">Description</p>
                        <Link href="/contact">
                            <Button className={"min-w-[100px] rounded-full"}>Liên hệ với chúng tôi</Button>
                        </Link>
                    </div>
                </section>
                <Footer />

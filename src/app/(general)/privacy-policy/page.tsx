      ...
      <div className="flex">
        ...
        <div className="flex-1 bg-white rounded p-6">
          ...
          <p className="indent-8">
            Pitch4u.vn tôn trọng những thông tin cá nhân của bạn. Chúng tôi hiểu
            rằng bạn cần biết chúng tôi quản lý những thông tin cá nhân tập hợp
            được từ Pitch4u.vn như thế nào. Hãy đọc và tìm hiểu về những quy
            định bảo mật thông tin sau đây. Việc bạn truy cập, đăng ký, sử dụng
            Pitch4u.vn có nghĩa rằng bạn đồng ý và chấp nhận ràng buộc bởi các
            điều khoản của bản quy định bảo mật của chúng tôi.
          </p>
          ...
          <section id="how-to-use-information" className=" pt-4 md:pt-10">
            ...
            <p className="indent-8">
              ...
              Thông tin cá nhân của bạn sẽ không bị chia sẻ với bất kỳ bên thứ
              ba nào khi chưa có sự đồng ý của bạn. Nhưng chúng tôi có thể chia
              sẻ thông tin cho bên đối tác khi bạn đồng ý. Dữ liệu khách hàng
              của Pitch4u.vn có thể được chuyển nhượng cho người kế thừa hay
              người được chỉ định để quản lý công ty khi công ty bị sát nhập, bị
              mua lại hoặc phá sản.
            </p>
          </section>
          <section
          ...
          >
            ...
            <p className="indent-8">
              ...
              chúng tôi duy trì các biện pháp thích hợp nhằm bảo đảm tính an
              ...
              an toàn cho các thông tin mà chúng tôi cung cấp cho họ nếu có.
            </p>
          </section>
          <section id="cookies" className=" pt-4 md:pt-10">
            ...
            <p className="indent-8">
              ...
              trong một Website. Chúng tôi sử dụng cookies để ghi chép các hoạt
              ...
              người sử dụng và các mục đích khác.
            </p>
          </section>

          <section id="link-to-other-website" className=" pt-4 md:pt-10">
            <h3 className="text-xl font-semibold">Liên kết các Website khác</h3>
            <p className="indent-8">
              Nếu bạn nhấn đường liên kết sang Website thứ ba, bao gồm cả trang
              quảng cáo, bạn sẽ rời trang Pitch4u.vn và sẽ đến trang Web bạn đã
              chọn. Chúng tôi không thể kiểm soát các hoạt động của bên thứ ba
              và không chịu trách nhiệm về sự an toàn hay bất kể những nội dung
              gì có trong Website đó.
            </p>
          </section>
          <section
          ...
          >
            ...
            <p className="indent-8">
              ...
              lúc nào. Cho dù, bạn tự xoá các thông tin đó đi nhưng chúng tôi có
              thể phục hồi những thông tin đó từ cơ sở dữ liệu của chúng tôi để
              giải quyết các tranh chấp, thi hành bản thoả thuận người sử dụng,
              hay vì các yêu cầu kỹ thuật, pháp lý liên quan đến sự an toàn và
              những hoạt động của trang website chúng tôi.
            </p>
          </section>
          <section id="terms-change" className=" pt-4 md:pt-10">
            ...
            <p className="indent-8">
              ...
              từ chối các điều khoản thay đổi có trong Pitch4u.vn, xin liên hệ
              chúng tôi theo địa chỉ email sporta.hotro@gmail.vn. Khi bạn tiếp
              tục sử dụng trang web này, có nghĩa là bạn đồng ý và chấp nhận bị
              ràng buộc với các thay đổi trong bản quy định bảo mật trực tuyến
              này.
            </p>
          </section>
